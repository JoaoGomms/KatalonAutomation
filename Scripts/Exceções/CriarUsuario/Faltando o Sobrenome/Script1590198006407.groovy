...
WebUI.setText(findTestObject('PaginaInserirDadosUsuario/input_ltimo nome _userlastname'), '')
...
CustomKeywords.'cabal.utils.TakeScreenshotLocal.takeScreenshot'('PaginaCriarUsuario', 'SobrenomeEmBranco', 'FluxoExcecao')