...
WebUI.setText(findTestObject('PaginaInserirDadosUsuario/input_Profisso_userprofile'), '')
...
CustomKeywords.'cabal.utils.TakeScreenshotLocal.takeScreenshot'('PaginaCriarUsuario', 'ProfissaoEmBranco', 'FluxoExcecao')
