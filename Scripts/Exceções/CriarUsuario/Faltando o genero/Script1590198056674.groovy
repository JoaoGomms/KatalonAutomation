...
WebUI.setText(findTestObject('PaginaInserirDadosUsuario/input_Gnero_usergender'), '')
...
CustomKeywords.'cabal.utils.TakeScreenshotLocal.takeScreenshot'('PaginaCriarUsuario', 'GeneroEmbranco', 'FluxoExcecao')